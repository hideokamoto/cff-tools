...
import { CreateFunctionRequest, DeleteFunctionRequest, DescribeFunctionRequest, FunctionBlob, FunctionEventObject, PublishFunctionRequest, TestFunctionRequest, UpdateFunctionRequest } from "aws-sdk/clients/cloudfront";
...
export class Function {
    ...
    constructor(props: FunctionProps, options?: FunctionOptions & {
        client?: CloudFront
    }) {
        ...
        if (options) {
            ...
            if (options.functionFilePath) this.options.functionFilePath = options.functionFilePath
    ...
    public async testFunction(event: FunctionEventObject, stage: FunctionStage = 'DEVELOPMENT') {
